...
class CreatedEventsPagingSource(private val repository: WebRepository, private val isDownloaded: suspend (String)-> Boolean) :
    ...
    override suspend fun load(params: LoadParams<Int>): LoadResult<Int, QuestShortInfo> {
        ...
        params.loadSize
        return try {
            val responseData = repository.getCreatedEvents(pageIndex, 10, isDownloaded)
            ...
            Log.e("LOAD_CREATED_EVENT_LIST", (e.message ?: "") + ((e.cause?.message) ?: " "))
            LoadResult.Error(e)
        }
    }
